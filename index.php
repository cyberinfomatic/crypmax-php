...
<meta name="description" content="Bitcoin And Crypto Currency ">
...
<!-- Document Title
    ============================================= -->
<title>crypmax | Bitcoin And Crypto Currency </title>
</head>
<body>
<div class="preloader">
...
<header id="navbar-spy" class="header header-1 header-transparent header-bordered header-fixed">
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="logo" href="index.php">
					<img class="logo-light" src="assets/images/logo/logo-light.png" alt="Enrmous Logo" style="width: 200px;">
					<img class="logo-dark" src="assets/images/logo/logo-dark.png" alt="Enrmous Logo" style="width: 200px;">
				</a>
			</div>
	...
	<!-- Elements Menu -->			</ul>
				...
				</div><!-- .module-search end -->				<!-- Module Consultation  -->	<!-- Module Signup  -->
			...
			<div class="modal-content">
				<div class="modal-body">
					...
					<div class="signup-form-container text-center">
							<h4>signup</h4>
							<form id="signupPopupForm" method="post" action="http://localhost/template/niche/crypmax/html/dev/assets/php/signuppopup.php" class="signupform">
				...
				<li data-transition="zoomout" 
					...
					<div class="tp-caption" 
						...
						<div class="slide-action">
							...
							<a class="btn btn--video popup-video" href=""><i class="fa fa-play"></i>Watch Video</a>
						</div>
					</div>
				</li>
			...
			<div class="row clearfix">
				<div class="col-xs-12 col-sm-4 col-md-3 footer--widget widget-about">
					<div class="widget-content">
						<img class="footer-logo" src="assets/images/logo/logo-light.png" alt="logo" style="width: 200px;">
						<p>Exchange Cryptocurrency at the Best Rate by getting the best offer from all the exchanges at one place.</p>
						<div class="copyright">
							<span>copyright ©2024 Cyberinfomatic All Rights Reserved</span> 
						</div>
					</div>
				</div><!-- .col-md-3 end -->
